...
```{r}
df2019$n_LAKAS_PRED = scale(df2019$LAKAS_PRED)
df2019$n_HO_FORG_RB = scale(df2019$HO_FORG_RB)
df2019$n_HO_FORG_OSSZ = scale(df2019$HO_FORG_OSSZ)
df2019$n_SZJA = scale(df2019$SZJA)
df2019$n_BERUHAZAS = scale(df2019$BERUHAZAS)
